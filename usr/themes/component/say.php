...
<div id="comments" class="timeMachine">
    ...
    no-borders border-radius-6">
            ...
            <i class="animate-spin fontello fontello-spinner hide" id="spin"></i>
                        ...
                        <!--模态框-->
                        <?php
                        echo Content::returnCrossInsertModelHtml("imageInsertModal", "imageInsertOk", _mt("插入图片"), _mt("请在下方的输入框内输入要插入的远程图片地址"), "img");
                        echo Content::returnCrossInsertModelHtml("videoInsertModal", "videoInsertOk", _mt("插入视频"), _mt("请在下方的输入框内输入要插入的远程视频地址"), "video");
                        echo Content::returnCrossInsertModelHtml("musicInsertModal", "musicInsertOk", _mt("插入音乐"), _mt("请在下方的输入框内输入要插入的单曲地址或者远程音乐地址"), "music");
                        ?>
