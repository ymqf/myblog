              ...
              <b class="fn"><?php echo $author; ?></b>
                ...
                <?php endif; ?>
                        ...
                        <div class="comment-metadata">
                            <a href="#<?php $comments->theId()?>"><time class="format_time text-muted text-xs block m-t-xs" pubdate="pubdate" datetime="<?php $comments->date('c'); ?>"><?php echo Utils::formatDate($comments,$comments->created, $options->dateFormat); ?></time></a>
                        </div>
                    </div>
                    <!--回复内容-->
                    <div class="comment-content m-t-sm">
                        <span class="comment-author-at"><b><?php $parentMail = get_comment_at($comments->coid)
                            ...
                            <?php
                                echo CommentContent::postCommentContent($comments->content,$GLOBALS['isLogin'],$GLOBALS['rememberEmail'],$comments->mail,$parentMail,false,$comments->status == "approved");
                            ?>
                        </div>
                    </div>
                    <!--回复按钮-->
        ...
        <?php if($this->allow('comment')): ?>
            ...
            <?php else: ?>
                <div id="<?php $this->respondId(); ?>" class="respond comment-respond no-borders">
                    ...
                    <h4 id="reply-title" class="comment-reply-title m-t-lg m-b-none"><?php _me("发表评论") ?>
