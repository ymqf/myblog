    ...
    */
    public function translated(){
        return array(
            ...
            "确定" => "OK",
            "取消" => "Cancel",
            "编辑提示" => "Modify Reminder",
            "删除提示" => "Delete Reminder",
            "请输入修改后的标签名称（如果输入标签名称已存在，则会合并这两个标签）：" => "Please enter the modified label name (if the entered label name already exists, the two labels will be merged):",
            "确认要删除该标签吗，删除该标签的同时会删除与该标签绑定的评论列表" => "Are you sure you want to delete this tag? Deleting this tag will delete the comment list bound to this tag",
            "确认删除该条时光机吗？将无法恢复" => "Are you sure to delete this time machine? Will not be recoverable",

            "插入图片" => "Insert Picture",
            "请在下方的输入框内输入要插入的远程图片地址"=> "Please enter the remote picture address to be inserted in the input box below",
            "插入视频" => "Insert Video",
            "请在下方的输入框内输入要插入的远程视频地址"=> "Please enter the remote video address to be inserted in the input box below",
            "插入音乐" => "Insert Music",
            "请在下方的输入框内输入要插入的单曲地址或者远程音乐地址"=> "Please enter the single song address or remote music address to be inserted in the input box below",
            "本地上传" => "Upload From Local",
            "（私密）" => "(Private)",
